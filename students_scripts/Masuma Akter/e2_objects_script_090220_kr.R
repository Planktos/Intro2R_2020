...
##correction: looking for an explanation of what the difference is between the objects when recrusive is set to TRUE versus FALSE
## -0.5 points
...
L[,3,2] #you are extracting all the values in the second level and third column here
...
##correction: looking for more specificity in the symbols not allowed; -1 point
...
S['jerry']<-c(1:4)
##correction: so this a correct syntax for what you did which was assign new values (1:4) to the third column
##however, you did not assign it to a new object; -0.5 points
a <- S['jerry']

##9b) Assign the data in the data frames second row to a new object.
S[2,]<-c(5:8)
## correction; you are setting the values in the second row to be 5,6,7,8; -0.5 points
b <- S[2,]
